...
const Home = () => {
  ...
  return <div className="min-h-screen bg-white">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => 
              <div key={index} className="text-center p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 group">
                ...
                <p className="text-gray-600 font-lato text-base">{feature.description}</p>
              </div>
            )}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-arvo font-semibold text-gray-800 mb-4 md:mb-6 px-2">Featured Tours</h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed font-lato px-4 md:px-0">
      ...
      <section className="py-16 sm:py-20 md:py-24 bg-gradient-to-br from-coolBlue-700 to-coolBlue-500">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-playfair-sc font-semibold text-white mb-4 md:mb-6 px-2">What Our Travelers Say</h2>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed font-lato px-4 md:px-0">
              ...
              <div key={index} className="bg-white rounded-lg p-6 shadow-lg transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 hover:shadow-xl group">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 font-lato text-base">{testimonial.country}</p>
                  </div>
                </div>
                ...
                <p className="testimonial-quote text-gray-700 text-base leading-relaxed">"{testimonial.comment}"</p>
              </div>
            )}
          </div>
        </div>
